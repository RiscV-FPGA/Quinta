...
add_files [file join "$ROOT" src lib common_instructions_pkg.sv]
add_files [file join "$ROOT" src lib common_pkg.sv]
add_files [file join "$ROOT" src alu.sv]
add_files [file join "$ROOT" src control.sv]
add_files [file join "$ROOT" src data_memory.sv]
add_files [file join "$ROOT" src decompressor.sv]
...
add_files [file join "$ROOT" src instruction_mem.mem]
add_files [file join "$ROOT" src instruction_memory.sv]
add_files [file join "$ROOT" src memory_stage.sv]
add_files [file join "$ROOT" src registers.sv]
