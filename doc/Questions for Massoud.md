...
2. C.JAL & c.JALR wants you to add ra when decompressing the instruction, where does one get that?
3. SRLI, SRAI & SLLI seem to misfit between the compacted and non compacted, 5th bit of imm dissapears?
4. Difference in how the book and sheet sheet define for c.mv. 